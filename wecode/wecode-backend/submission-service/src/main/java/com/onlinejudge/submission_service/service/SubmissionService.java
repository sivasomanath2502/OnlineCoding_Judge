...
public class SubmissionService {
    ...
    public SubmissionResponse submit(SubmissionRequest request) {
        ...
        try {
            ...
            log.info("Step 4: Language found - {}",
                    language.getName());
            ...
            MDC.put("submissionId", saved.getId().toString());

            log.info("Step 7: Flushing to DB");

            log.info(
                    "Step 7: Flushing to DB - submission id={}, problem_id={}, language_id={}",
                    submission.getId(),
